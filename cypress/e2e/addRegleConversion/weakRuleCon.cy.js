describe("weakRuleCon", () => {
  it("tests weakRuleCon", () => {
    cy.viewport(964, 658);
    ...
    cy.get("form").click();
    cy.get("#puid").click();
    cy.get("#puid").type("fmt/291");
    cy.get("#conversionService").click();
    cy.get("#conversionService").type("dependency/fileSystem/plugins/libreOffice");
    cy.get("#targetPuid").click();
    cy.get("#targetPuid").type("");
