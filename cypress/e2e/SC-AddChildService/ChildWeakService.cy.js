describe("ChildWeakService", () => {
  it("tests ChildWeakService", () => {
    cy.viewport(998, 658);
    ...
    cy.get("#organization_organizationForm form > div:nth-of-type(1) input").type("o");
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").click();
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").type("o");
