describe("addPlanQuot", () => {
  it("tests addPlanQuot", () => {
    cy.viewport(998, 658);
    ...
    cy.get("#name").click();
    cy.get("#name").type("semaine");
    cy.get("#taskId").click();
    cy.get("#taskId").type("01");
    cy.get("div:nth-of-type(8) select.col-xs-4").click();
    cy.get("div:nth-of-type(8) select.col-xs-4").type("09");
    cy.get("#repetitionOn").click();
    cy.get("#repetitionForm select.col-xs-4").click();
    cy.get("#repetitionForm select.col-xs-4").type("17");
