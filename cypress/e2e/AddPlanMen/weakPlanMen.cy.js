describe("weakPlanMen", () => {
  it("tests weakPlanMen", () => {
    cy.viewport(998, 658);
    ...
    cy.get("label:nth-of-type(8)").click();
    cy.get("tr:nth-of-type(3) > td:nth-of-type(5)").click();
    cy.get("div:nth-of-type(8) select.col-xs-4").click();
    cy.get("div:nth-of-type(8) select.col-xs-4").type("08");
