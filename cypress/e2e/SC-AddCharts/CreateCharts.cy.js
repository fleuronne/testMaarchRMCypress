describe("CreateCharts", () => {
  it("tests CreateCharts", () => {
    ...
    cy.get("#organization_organizationForm form > div:nth-of-type(1) input").type("isj");
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").click();
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").type("isj");
