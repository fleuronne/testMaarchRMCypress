describe("AddChildCharts", () => {
  it("tests AddChildCharts", () => {
    cy.viewport(998, 658);
    ...
    cy.get("ul:nth-of-type(3) div > i").click();
    cy.get("ul:nth-of-type(3) li.addChildOrganization > a").click();
    cy.get("#organization_organizationForm form > div:nth-of-type(1) input").click();
    cy.get("#organization_organizationForm form > div:nth-of-type(1) input").type("consulting");
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").click();
    cy.get("#organization_organizationForm div:nth-of-type(3) > input").type("consulting");
